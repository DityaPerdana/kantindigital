...
export default function LandingPage() {
  ...
  return (
    <div className="min-w-full min-h-screen bg-primary">
      {/* <Image src="/sun-svgrepo-com.svg" alt="sun image" width={100} height={100} id="sun" className=""/>   */}
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" id="sun">
        ...
        <g id="SVGRepo_iconCarrier">
          <path d="M7 3V0H9V3H7Z" fill="#000000"></path>{" "}
          <path d="M9 13V16H7V13H9Z" fill="#000000"></path>
          <path
            d="M11 8C11 9.65685 9.65685 11 8 11C6.34315 11 5 9.65685 5 8C5 6.34315 6.34315 5 8 5C9.65685 5 11 6.34315 11 8Z"
            fill="#000000"
          ></path>
          <path d="M0 9H3V7H0V9Z" fill="#000000"></path>
          <path d="M16 7H13V9H16V7Z" fill="#000000"></path>
          <path
