...
import { NotificationSetupClient } from "@/components/notification-setup-client"
...
export function OrderDetailClient({ initialOrder, orderItems }: OrderDetailClientProps) {
  // Use real-time hook for order updates
